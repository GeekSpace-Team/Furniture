...
public class Product {
    ...
    public Product(int id, String product_id, int categoryId, String image, String name, String product_name_ru, String category, double cost, double product_discount, boolean isFav, boolean is_popular) {
        this.id = id;
